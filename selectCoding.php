...
<body>
    ...
    <div class="mainabbu">
        <div class="main">
            ...
            <div class="btnmode ">
                <div class="btn"><a href="python.php">Python</a> </div> <br>
                <div class="btn"> <a href="js.php">JavaScript</a> </div> <br>
                <div class="btn"> <a href="cPlus.php">C++</a> </div> <br>
               
                <div class="btn"> <a href="assembly.php">Assembly Language</a> </div>
