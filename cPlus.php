...
<body>
    ...
    <div class="mainabbu">
        <div class="main">
            <h2 class="name"> <strong>Coding Mode - </strong>C++ </h2>
...
int main() {
    ...
    `<pre>cout << "Type something: ";
string userInput;
getline(cin, userInput);</pre>`,
    `<pre>if (userInput == "John") {
cout << "Congratulations, your name is correct!" << endl;</pre>`,
    `<pre>int num1;
cout << "Enter the first number: ";</pre>`,
    `<pre>int sum = num1 + num2;
