...
$sql = "SELECT easy FROM scores WHERE uname='$username'";
...
if ($result->num_rows > 0) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($typingspeed > $dbvalue) {
            ...
            $sql = "UPDATE scores SET easy = $typingspeed WHERE uname='$username'";
            $conn->query($sql);
        }
    }
...
<div class="mainabbu">
    <div class="main">
    <h2 class="name"> <strong>Countdown Mode - </strong> Easy level </h2>
            <h3 class="heading">You have to complete the sentence in 40 seconds</h3>
            <p class="sentence"></p>
