...
// $sql = "SELECT javascript FROM scores WHERE username='$username'";
// $result = $conn->query($sql);

// if ($result->num_rows > 0) {
//     $row = $result->fetch_assoc();
//     $dbvalue = $row['javascript'];

//     // Compare the PHP variable with the database value
//     if ($wpm > $dbvalue) {
//         // Update the database value
//         $sql = "UPDATE scores SET javascript = $wpm WHERE username='$username'";
//         $conn->query($sql);
//     }
// }
?>
...
<body>
    ...
    <div class="mainabbu">
        <div class="main">
            <h2 class="name"> <strong>Coding Mode - </strong>Javascript </h2>
...
btn.addEventListener('click', handleClick);</pre>`,
  ...
  console.log('Button clicked!');
    ...
    `<pre>const inp = document.getElementById('inp');
inp.addEventListener('input', handleInput);</pre>`,
    `<pre> event.preventDefault();
console.log('Form submitted!');</pre>`
];
